...
public class TrendingInIndiaActivity extends AppCompatActivity {
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        songs.add(new Songs("Suraiyya", "Thugs of Hindostan",
                R.drawable.play_button));
        songs.add(new Songs("Zindagi Mil Jayegi", "Zindagi Mil Jayegi",
                R.drawable.play_button));
        songs.add(new Songs("Kamariya", "Mitron",
                R.drawable.play_button));
        songs.add(new Songs("Chogada", "Raatri",
                R.drawable.play_button));
        songs.add(new Songs("Sajan Bade Senti", "Badhai Ho",
                R.drawable.play_button));
        ...
        songs.add(new Songs("Subah Hone na De (Remix)", "Dishoom",
                R.drawable.play_button));
        songs.add(new Songs("Dholida", "Loveyatri",
                R.drawable.play_button));
        songs.add(new Songs("Chhod Diya", "Baazaar",
                R.drawable.play_button));
